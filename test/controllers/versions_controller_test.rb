...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { description: @version.description, exercise_id: @version.exercise_id, title: @version.title, user_id: @version.user_id } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { description: @version.description, exercise_id: @version.exercise_id, title: @version.title, user_id: @version.user_id } }
